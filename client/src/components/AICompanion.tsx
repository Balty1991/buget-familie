...
export type FinancialUpdate = { kind: "income"; amount: number; title: string } | { kind: "debt"; name: string; remaining: number } | { kind: "debt-monthly"; amount: number } | { kind: "allocation"; category: string; amount: number; weekly: boolean };
