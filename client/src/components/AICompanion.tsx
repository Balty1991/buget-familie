...
export function AICompanion({ data, view, onAdd, onGo, onNaturalEntry, onFinancialUpdate }: Props) {
  ...
  const clearChat = () => {
    if (!window.confirm("Golești conversația ghidului? Mișcările și plicurile rămân în registru.")) return;
    setMessages([]);
