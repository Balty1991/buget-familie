...
export function AIFinancialSetup({ data, onChange, onClose, onGoPlan, onAdd }: Props) {
  ...
  const apply = () => {
    ...
    window.localStorage.setItem("buget-familie:setup-complete", "true"); markSetupCompletedAt(window.localStorage);
  ...
  const skip = () => { window.localStorage.setItem("buget-familie:setup-complete", "true"); markSetupCompletedAt(window.localStorage); window.localStorage.setItem("buget-familie:onboarding-complete", "true"); onClose(); };
