...
const family = () => {
  ...
  data.settings.salaryPlan = { ...data.settings.salaryPlan, periodStart: "2026-10-05", nextPayday: "2026-11-01", paydayFlexDays: 0, allocations: [
  ...
  data.transactions = [
    { id: "a", title: "Lidl", amount: 450, kind: "expense", category: "Alimente", source: "", person: "", date: "2026-10-06", allocationId: "m" },
    { id: "b", title: "Bolt", amount: 120, kind: "expense", category: "Transport", source: "", person: "", date: "2026-10-07", allocationId: "t" },
  ];
  return data;
};
...
describe("ghidul și plicurile", () => {
  it("„cât mai am la mâncare?” răspunde din săptămâna în curs și din plic", () => {
    const answer = analyze("cât mai am la mâncare?", family(), "2026-10-08")!;
...
describe("prin ghid", () => {
  it("întrebarea ajunge la răspunsul plicului, nu la o cheltuială", async () => {
    ...
    const top = understand("cât mai am la mâncare?", family(), { asOf: "2026-10-08" }).sort((a, b) => b.score - a.score)[0];
