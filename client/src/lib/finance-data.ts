...
export const TOMBSTONE_ENTITIES = ["transactions", "debts", "savings", "receipts", "recurring", "allocations", "transfers", "weekTransfers", "salaryRules", "plannedEvents", "members", "categories", "paymentSources", "exchangeRates"] as const;
