...
export const USAGE_LESSONS: UsageLesson[] = [
  ...
  },
  {
    ...
    how: "Sync e opțional. Primul telefon creează camera familiei, celelalte intră cu invitația.",
    nav: "Familie",
    paragraphs: [
      "Poți ține registrul doar pentru tine. Membrii în plus sunt opționali: cine a plătit, din ce sursă, personal sau comun.",
      "Sincronizarea e o cameră a familiei, nu un cont Google. Primul telefon o creează, iar partenerul intră cu invitația trimisă pe WhatsApp sau SMS. Fiecare telefon își alege membrul („Cine ești pe acest telefon?”). Pe Astăzi, „Cine a mișcat banii” arată ciclul, nu ultimele rânduri locale.",
      "La crearea camerei primești un cod de recuperare. Notează-l pe hârtie: dacă schimbi telefonul fără backup, cu el intri din nou în familie.",
    ],
