...
export default function Home() {
  ...
  const nav = [{ id: "today" as MainView, label: "Astăzi", icon: LayoutDashboard }, { id: "journal" as MainView, label: "Mișcări", icon: WalletCards }, { id: "plan" as MainView, label: "Plan", icon: Goal }, { id: "obligations" as MainView, label: "Obligații", icon: BellRing }, { id: "insights" as MainView, label: "Analiză", icon: BarChart3 }];
