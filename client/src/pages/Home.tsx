...
export default function Home() {
  ...
  const deleteReceipt = (id: string) => {
    ...
    void removeReceiptImages(receipt?.imageKeys).catch(() => setReceiptStorageNotice("Bonul a fost șters din registru, dar telefonul nu a confirmat încă ștergerea fotografiei locale."));
