...
export type ThemeId = "snow" | "ivory" | "ink" | "sand" | "sage" | "slate" | "lagoon" | "forest" | "midnight" | "navy" | "graphite" | "copper" | "plum" | "rosewood";
...
export const LIGHT_THEMES: ThemeId[] = ["snow", "ivory", "ink", "sand", "sage", "slate", "lagoon"];
...
export const themeOptions: Array<{ id: ThemeId; name: string; detail: string; mood: string }> = [
  ...
  { id: "ink", name: t("Ink Studio"), detail: t("Monocrom profesional: gri-cerneală, alb de hârtie, fără accente colorate. Pregătit pentru Play."), mood: "ZI · MONOCROM" },
  ...
  { id: "graphite", name: "Grafit", detail: t("Negru grafit monocrom, accent gri-argintiu. Neutru, fără verde."), mood: "NOAPTE · MONOCROM" },
