...
import { AlertTriangle, BellRing, BrainCircuit, BookOpen, Bot, CalendarClock, CalendarDays, Camera, Check, Gift, Images, Inbox, ChevronLeft, ChevronRight, Cloud, Download, Goal, LayoutDashboard, Search, Palette, Pencil, PiggyBank, Plus, ReceiptText, Settings, ShieldCheck, ShoppingBasket, Store, PiggyBank as PiggyBankIcon, Trash2, Users, WalletCards, X } from "lucide-react";
import { addIsoDays, createEmptyAppData, expenseCategories, formatDate, isoToday, matchingAllocationsForExpense, newId, parseRomanianAmount, recordDebtPayment, guessCategoryFromText, resolveReceiptLines, sourceBalance, type AppData, type Debt, type Receipt, type SavingsGoal } from "@/lib/finance-data";
