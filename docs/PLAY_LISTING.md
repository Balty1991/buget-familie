...
**Versiune pentru listing (sept 2026):** `1.1.67` / `versionCode` **69** (`package.json` + `android/app/build.gradle`). Textul lung de lipit e în `play-store-listing-ro.md`, nu aici.
